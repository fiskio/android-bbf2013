...
public class WishlistActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// check db
		Cursor beerCursor = MainActivity.db.getReadableDatabase().rawQuery("SELECT _id, brewery, beername, type, color, abv, description, icon, rating, drunk FROM beerlist WHERE wishlist=1", null);
